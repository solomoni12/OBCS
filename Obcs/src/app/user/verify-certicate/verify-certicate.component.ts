...
@Component({
  selector: 'app-verify-certicate',
  templateUrl: './verify-certicate.component.html',
  styleUrls: ['./verify-certicate.component.css']
})
export class VerifyCerticateComponent implements OnInit {
